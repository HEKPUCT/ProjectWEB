...
<div class="moreAbout">
    ...
    <div class="moreAboutContent">
        <div class="moreAboutDataContent">
            <p><img class ="moreNewsImage1" src="../img/about/aboutas.png">
                ...
                <img class ="moreNewsImage2" src="../img/about/aboutas.jpg">
                Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diem nonummy nibh
                euismod tincidunt ut lacreet dolore magna aliguam erat volutpat. Ut wisis enim
                ad minim veniam, quis nostrud exerci tution ullamcorper suscipit lobortis nisl
                ut aliquip ex ea commodo consequat.
...
<footer class="footerPage">
    <div class="footerTextPage">
        ...
        <div class="copyrightText">
            <p> При перепечатке материала активная ссылка на сайт <a href="../index.php">  ешьТомат.ru</a>  обязательна.</p>
        </div>
    </div>
</footer>
</html>
