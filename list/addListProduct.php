...
<div class="addListProduct">
    ...
    <form class='productCatalogContent' method='POST' enctype="multipart/form-data"
    <?php echo "action='upload.php?idCatalog=" . $idCatalogGroup . "' >"; ?>
    ...
    <div class='addNewsArticle'>
        ...
        <div class="contentAddNews">
            <div>
                <p>Название: <input type='text' name='nameProduct'></p>
                <p>Цена без акции: <input type='number' name='price'></p>
                <p>Цена по акции: <input type='number' name='pricePerShare'></p>
                <p>Количество товара: <input type='number' name='countProduct'></p>
            </div>
            <div class="inputElement">
                <p>Описание:</p>
                <textarea name="discription" cols="160" rows="30"></textarea>
            </div>
            <div>
