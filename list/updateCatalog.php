...
<div class="addListProduct">
    ...
    <?php echo "'updateC.php?idCatalog=" . $idCatalog . "' >"; ?>
            ...
            if (!$result) {
                ...
                foreach ($result as $name => $value) {
                    if ($value["id"] == $idCatalog) {
                        echo "<p>Название: <input type='text' name='nameCatalog' value='" . $value["nameGroupProduct"] . "'></p>
                        </div>
                        <p>Акция: <input name='checkbox' type='checkbox' value='1' /> </p>  
                        <div class='inputElement'>
                            <p>Описание:</p>
                            <textarea name='description' cols='160' rows='30' >" . $value['description'] . " </textarea>
                        </div>
                        <div>
